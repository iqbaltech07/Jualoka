...
const defaultItems: CartItem[] = [
    { id: "1", name: "Keripik Singkong Pedas Gila", price: 15000, quantity: 2 },
    { id: "3", name: "Kopi Gula Aren Literan", price: 65000, quantity: 1 },
]
                ...
                <div className="grid gap-6 lg:grid-cols-5">
                    ...
                    <div className="lg:col-span-3 space-y-3">
                        {items.map((item) => (
                            <div
                                key={item.id}
                                className="bg-white rounded-2xl p-4 sm:p-5 border border-border/50 shadow-sm hover:shadow-md transition-shadow flex gap-4 items-center"
                            >
                                {/* Thumbnail */}
                                ...
                                <div className="flex items-center gap-2 flex-shrink-0">
                                    <button
                                        ...
                                        className="h-7 w-7 rounded-lg border border-border bg-background flex items-center justify-center hover:border-primary hover:text-primary transition-colors"
                                    >
